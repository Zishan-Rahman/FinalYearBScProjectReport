...
The gramamr in the following example represents a D0L-System, a \textbf{deterministic} L-System using a context-free grammar; the grammar in the first example was \textit{also} deterministic.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/derivationtree.png}
    \caption{The first few steps of a derivation of our example grammar.}
