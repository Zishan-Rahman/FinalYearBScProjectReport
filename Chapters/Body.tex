...
\begin{figure}[H]
    ...
    \caption{A lattice generated with the example grammar on a Godot project for drawing from L-Systems. Source: Initial project written by YouTuber Codat\cite{codatGD3LSystemYT}, and converted to Godot 4 (with the addition of the lattice grammar) by me.}
    \label{fig:lattice2}
\end{figure}
