...
For this example\cite{enwiki:1124510226}, consider an alphabet $V$, which consists of the following symbols:
...
$$ \mbox{F} --> \mbox{F}+\mbox{F}-\mbox{F}-\mbox{F}\mbox{F}+\mbox{F}+\mbox{F}-\mbox{F} $$