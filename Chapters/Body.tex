...
\begin{figure}[H]
    ...
    \caption{The tileset used for all 4 implementations of my scenario with PCG algorithms.\cite{kenneyassetsused} Of all the 1078 tiles, of size 16x16, in this tileset, only 42 of them get referenced in my code.}
    \label{fig:kenneyset}
\end{figure}
