...
For instance, the Voronoï cells implementation involved the use of two different distance calculations that produced wildly differing cells and cell shapes.
...
In the Voronoï Cells implementation, we can choose whether to use the Euclidean or Manhattan distance calculation, each producing different kinds of Voronoï tesselations as shown in Figures \ref{fig:voronoicomparison} and \ref{fig:secondvoronoicomparison}.
