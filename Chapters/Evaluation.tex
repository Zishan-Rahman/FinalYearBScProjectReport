...
\begin{figure}[H]
    \centering
    \includegraphics{Images/poisson-3-samples.png}
    \caption{A level layout set with the number of rejection samples set to 3 instead of 8. This level took 87ms to create.}
    \label{fig:poisson2}
\end{figure}
